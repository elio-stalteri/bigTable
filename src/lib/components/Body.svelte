<script>
    ...
    import { refreshTableHeight } from '$lib/controller';
    ...
    $: if ($refreshTableHeight || tableHeight) {
        tableHeight = refTable.getBoundingClientRect().height;
    }
...
<div
    ...
    class=" z-10 relative flex-grow w-full h-full overflow-y-scroll scrollbar-thumb-gray-400
